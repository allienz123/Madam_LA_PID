...
class DcCustomerController extends OperatorController {
    /*
    ...
    */
    ...
    {
        // Show the page
        return view('operator.customers.dc_index');
    }
    ...
    public function addCid($id) {
        ...
        // Show the page
        return view('operator.customers.dc_index', compact('album'));
    }
    ...
    public function getCreate() {
        ...
        $service_type = "";
        return view('operator.customers.create_edit_dc_customer', 
    ...
    public function see($id) {
        ...
        return view('operator.customers.see_cid', compact('dccustomer','customers','customer','location','locations','service_type','service_types'));
    }
    ...
    public function getEdit($id) {
        ...
        $service_types = ServiceType::all();
        $service_type = $dccustomer->service_type;
        return view('operator.customers.create_edit_dc_customer', compact('dccustomer','customers','customer','location','locations','service_type','service_types'));
    ...
    public function getDelete($id)
    {
        $dccustomer = $id;
        // Show the page
        return view('operator.customers.dc_customer_delete', compact('dccustomer'));
    }
    ...
    public function data($albumid=0)
    {
        ...
        return Datatables::of($dccustomer)
            ->addColumn('Actions', '
                <a href="{{{ URL::to(\'operator/cid/\' . $id . \'/see\' ) }}}" class="btn btn-success btn-xs iframe"><span class="glyphicon glyphicon-eye-open"></span>  {{ trans("admin/modal.see") }}</a> 
                <a href="{{{ URL::to(\'operator/cid/\' . $id . \'/edit\' ) }}}" class="btn btn-warning btn-xs iframe"><span class="glyphicon glyphicon-pencil"></span>  {{ trans("admin/modal.edit") }}</a>')
            ->removeColumn('id')
