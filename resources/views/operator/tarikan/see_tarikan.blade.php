				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<input class="form-control" tabindex="1"
							...
							name="cid" id="cid"
							value="{{{ Input::old('cid', isset($tarikankabel) ? $tarikankabel->cid : null) }}}" disabled>
					</div>
				</div>
			</div>
		...
		<div class="form-group {{{ $errors->has('nama_pelanggan') ? 'has-error' : '' }}}">
				<div class="col-md-12 control-label" for="name">
						<label class="col-md-2 control-label" for="nama_pelanggan">{{
							...
							<div class="col-md-10">
						<select disabled style="width: 100%" name="nama_pelanggan" id="nama_pelanggan" class="form-control"> 
